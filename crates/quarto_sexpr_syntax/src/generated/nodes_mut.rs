...
use crate::{generated::nodes::*, SexprSyntaxToken as SyntaxToken};
...
impl SexprListValue {
    ...
    pub fn with_sexpr_list(self, element: SexprList) -> Self {
        Self::unwrap_cast(
            self.syntax
...
impl SexprRoot {
    pub fn with_value(self, element: AnySexprValue) -> Self {
        Self::unwrap_cast(
            self.syntax
