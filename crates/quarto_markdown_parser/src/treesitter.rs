...
fn node_syntax_kind(x: &Node) -> MarkdownSyntaxKind {
    match x.kind() {
        // "(" => MarkdownSyntaxKind::L_PAREN,
        // ")" => MarkdownSyntaxKind::R_PAREN,
        // "nil" => MarkdownSyntaxKind::NIL_KW,
        // "symbol" => MarkdownSyntaxKind::MARKDOWN_SYMBOL_VALUE,
        // "program" => MarkdownSyntaxKind::MARKDOWN_ROOT,
        // "list" => MarkdownSyntaxKind::MARKDOWN_LIST_VALUE,
        // "list_item" => MarkdownSyntaxKind::MARKDOWN_LIST,

        // "MARKDOWN_ROOT", 
        // "MARKDOWN_LIST_VALUE", 
        // "MARKDOWN_SYMBOL_VALUE",
        // "MARKDOWN_ITEM_LIST",
        // "MARKDOWN_LIST",
        // "MARKDOWN_LIST_ITEM",
...
pub trait NodeTypeExt: Sized {
    fn syntax_kind(&self) -> MarkdownSyntaxKind;
