...
When attributes are present, they are preserved in the resulting Span:

- `[!! text]{#my-id .extra}` → `Span ("my-id", ["quarto-highlight", "extra"], []) [...]`
- `[++ text]{key="val"}` → `Span ("", ["quarto-insert"], [("key", "val")]) [...]`

These classes and attributes can be used to apply styling in HTML output or to process the marks with Pandoc filters.
